...
namespace Lean.Touch
{
	...
	public class LeanSelectableDial : LeanSelectableBehaviour
	{
		...
		public float Angle { set { if (angle != value) { angle = value; if (onAngleChanged != null) onAngleChanged.Invoke(angle); } } get { return angle; } } [FSA("Angle")] [SerializeField] private float angle;
